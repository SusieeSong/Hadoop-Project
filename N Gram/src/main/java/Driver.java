...
public class Driver {
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException, InterruptedException {
		...
		DBConfiguration.configureDB(conf2, 
				...
				"jdbc:mysql://ip_address:port/test", //test: database name
				"root",
				"password");
		...
		//when map output and value type are different from reducer output key and value, need to
		//set mapputputkeyclass
